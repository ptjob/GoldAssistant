...
package com.parttime.widget.wheel;
...
import com.parttime.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawItems(Canvas canvas) {
        ...
        for (int i = 0; i < childCount; i++) {
            if (cur == i + firstItem) {
                ((TextView) itemsLayout.getChildAt(i)).setTextColor(Color.BLACK);
            } else {
                ((TextView) itemsLayout.getChildAt(i)).setTextColor(Color.GRAY);
            }
        }
