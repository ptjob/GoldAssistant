...
import com.quark.guanli.JianzhiShowActivity;
...
public class WriteJobActivity extends BaseActivity implements
	...
	public void sexOnclick(View view) {
		...
		case R.id.begin_time:
			ActionSheet.showSheetTime4(WriteJobActivity.this,
					WriteJobActivity.this, WriteJobActivity.this,
					begin_time);
			break;
		...
		case R.id.end_time_img:
			...
			break;
		case R.id.area:
			ActionSheet.showSheetCountry(WriteJobActivity.this,
					WriteJobActivity.this, WriteJobActivity.this, area);
			break;
		case R.id.area_img:
			ActionSheet.showSheetCountry(WriteJobActivity.this,
					WriteJobActivity.this, WriteJobActivity.this, area);
		...
		case R.id.require_language:
			ActionSheet.showSheetLanguage(WriteJobActivity.this,
					WriteJobActivity.this, WriteJobActivity.this,
					require_language);
			break;
		case R.id.require_shoe_weigth:
			ActionSheet.showSheetShoos(WriteJobActivity.this,
					WriteJobActivity.this, WriteJobActivity.this,
					require_shoe_weigth);
			break;
		case R.id.require_cloth_weight:
			ActionSheet.showSheetYiFZM(WriteJobActivity.this,
					WriteJobActivity.this, WriteJobActivity.this,
