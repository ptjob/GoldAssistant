 ...
 * 
 */
public class ChatAllHistoryCompanyFragment extends Fragment {
	...
	public static ChatAllHistoryCompanyFragment newInstance(String param1, String param2) {
		ChatAllHistoryCompanyFragment fragment = new ChatAllHistoryCompanyFragment();
		return fragment;
	}
	@Override
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		//联系人 加
		ImageView contactsView = (ImageView)getView().findViewById(R.id.contactsView);
