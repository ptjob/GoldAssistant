		...
		if (chatType == CHATTYPE_SINGLE) { // 单聊
			...
			if (toChatUsername != null && !"".equals(toChatUsername)) {
				if ("jianzhidaren".equals(toChatUsername)) {
					Editor edtt = sp.edit();
					edtt.putString("jianzhidaren" + "realname", "兼职达人团队");
					edtt.commit();
				} else if ("caiwu".equals(toChatUsername)) {
					Editor edtt = sp.edit();
					edtt.putString("caiwu" + "realname", "财务小管家");
					edtt.commit();

				} else if ("dingyue".equals(toChatUsername)) {
					Editor edtt = sp.edit();
					edtt.putString("dingyue" + "realname", "订阅小助手");
					edtt.commit();

				} else if ("kefu".equals(toChatUsername)) {
					Editor edtt = sp.edit();
					edtt.putString("kefu" + "realname", "兼职达人客服");
					edtt.commit();

				} else if ("tongzhi".equals(toChatUsername)) {
					Editor edtt = sp.edit();
					edtt.putString("tongzhi" + "realname", "通知中心");
					edtt.commit();
			...
			String chatName = sp.getString(toChatUsername + "realname", "");
			if (!"".equals(chatName)) {
