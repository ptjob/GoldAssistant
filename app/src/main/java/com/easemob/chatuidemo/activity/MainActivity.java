...
public class MainActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fragments = new Fragment[] { contactListFragment, contactListFragment,
				settingFragment };
		// 添加显示第一个fragment
		// getSupportFragmentManager().beginTransaction().add(R.id.fragment_container,
		// chatHistoryFragment)
		// .add(R.id.fragment_container,
		// contactListFragment).hide(contactListFragment).show(contactListFragment).commit();

		// carson update on 2015-4-8-11:43
