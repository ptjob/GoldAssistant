...
public class DiskLruCache {
    ...
    public static DiskLruCache openCache(Context context, File cacheDir,
        ...
        //
        return new DiskLruCache(context.getCacheDir(),maxByteSize);
    }

    /**
     * Constructor that should not be called directly, instead use
     * {@link com.mdj.mdjmeijia.http.image.DiskLruCache#openCache(android.content.Context, java.io.File, long)} which runs some extra
     ...
     * be called directly, call {@link com.mdj.mdjmeijia.http.image.DiskLruCache#clearCache(android.content.Context, String)}
     * or {@link com.mdj.mdjmeijia.http.image.DiskLruCache#clearCache()} instead.
     *
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
            ...
            Logger.i("DiskLruCache","sdcard exit and mount.");
            cachePath =  Utils
                    .getExternalCacheDir(context).getPath();
        } else {
            cachePath = context.getCacheDir().getPath();
        }
        Logger.i("DiskLruCache","cachePath :"+cachePath);
     ...
     * {@link com.mdj.mdjmeijia.http.image.DiskLruCache#setCompressParams(android.graphics.Bitmap.CompressFormat, int)} first to set
