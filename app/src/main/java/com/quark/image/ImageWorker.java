...
public abstract class ImageWorker {
	 ...
	 * {@link com.mdj.mdjmeijia.http.image.ImageWorker#processBitmap(Object)} to define the processing
	 * logic). A memory and disk cache will be used if an {@link ImageCache} has
	 * been set using {@link com.mdj.mdjmeijia.http.image.ImageWorker#setImageCache(ImageCache)}. If the
	 ...
	 * image is found in the memory cache, it is set immediately, otherwise an
	 * {@link android.os.AsyncTask} will be created to asynchronously load the bitmap.
	 * {@link com.mdj.mdjmeijia.http.image.ImageWorker#setAdapter(com.mdj.mdjmeijia.http.image.ImageWorker.ImageWorkerAdapter)} must be called before
	 * using this method.
	 * 
	 * @param data
	 *            The URL of the image to download.
	 ...
	 *            {@link com.mdj.mdjmeijia.http.image.ImageWorker#loadImage(Object, android.widget.ImageView)}
